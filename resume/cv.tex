...
{\small I am currently building robust inference serving systems for realtime voice AI applications serving 10M+ monthly voice minutes. Some of my works that I am proud of are an architectural change around whisper to enable 2.5$\times$ increase in throughput with minimal hit on performance, a scheduling strategy for ASR systems to achieve 43\% reduction in median E2E latency at high loads (Published at ICLR 2026)}

{\small In house MLOps agent for automating deployments, observability and alternating systems for jenkins jobs, giblab merge request testing automation and CI/CD pipelines}
\item \textbf{Hackathon} \hfill Jan 2026\\
...
{\small Benchmarked audio codecs for use in STT and TTS applications. Built a prototype of a unified voice agent for customer support services. Received pre placement offer (PPO).}
\end{itemize}
...
This is a framework for structural optimization of trusses under loading. It uses a matrix formulation of structures and gradient based optimization to compute the optimal spatial configuration of the structure under any loading condition. This was my final course project for ME 787
\end{minipage}%
\hfill
\begin{minipage}[t]{0.15\textwidth}
\vspace{-5pt}
...
One day I wondered why not use fractal curves for tool path planning in layered 3D printing. This is a tool path planning algorithm that I wrote which uses fractal curves via recursive decomposition. The entire layer is thus a single continuous path. This was my final course project for ME 724
\end{minipage}%
\hfill
\begin{minipage}[t]{0.15\textwidth}
\vspace{-5pt}
...
\vspace*{0.1in}
{\bf Duration Aware Scheduling for ASR Serving Under Workload Drift} \hfill ICLR 2026\\
