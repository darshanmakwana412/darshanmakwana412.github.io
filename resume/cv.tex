...
\name{Darshan Makwana}
\address{\textit{\href{mailto:darshanmakwana412@gmail.com}{darshanmakwana412@gmail.com}} \\ \href{https://github.com/darshanmakwana412}{GitHub} \\ \href{https://www.linkedin.com/in/darshan-makwana-282480228/}{LinkedIn} \\ \href{https://x.com/darshanvoid}{Twitter}}
...
My name is Darshan Makwana and I am an AI engineer at \href{https://riverline.ai/}{Riverline AI} building robust and scalable agentic eval systems. Prior to this I was an ML engineer at \href{https://www.sprinklr.com/}{Sprinklr} working on real time voice AI systems and improving their ASR inference. I was also a Research Assistant at \href{https://users.aalto.fi/~kannalj1/}{Aalto Vision Lab} working on \href{https://en.wikipedia.org/wiki/Gaussian_splatting}{3D Gaussian Splatting} and also did a summer research internship at \href{https://www.tum.de/en/}{TU Munich} on \href{https://en.wikipedia.org/wiki/Legged_robot}{quadruped robotics}.
% My name is Darshan Makwana and I am a Machine Learning Engineer at \href{https://www.sprinklr.com/}{Sprinklr} where I am working on real time voice AI systems and building robust systems for ASR inference. Prior to this I was a Research Assistant at \href{https://users.aalto.fi/~kannalj1/}{Aalto Vision Lab} working on 3D Gaussian Splatting and also did a summer research internship at \href{https://www.tum.de/en/}{TU Munich} on quadruped robotics

\vspace{0.1in}
I graduated from \href{https://www.iitb.ac.in/}{IIT Bombay} with a B.Tech in Mechanical Engineering and Dual Minor in Computer Science and Machine Learning. My interests span efficient ML serving systems, 3D reconstruction and endurance sports.
\end{minipage}%
\hfill
...
\begin{rSection}{Education}
    ...
    {\small Data Analytics Team of the Undergraduate Academic Council}
...
{\bf Riverline AI} {\hfill Bengaluru, India}\\
\textit{AI Engineer (Full-time)} \hfill May 2026 - Present\\
Building end to end eval pipelines for voice agents, scoring live and recorded call sessions across compliance adherence, litigation constraints, and operational spec conformance. Developing automated agentic judges to flag violations and measure agent behavior across multi turn conversations.

\vspace{0.15in}

{\bf Sprinklr} {\hfill Gurugram, India}\\
\textit{Machine Learning Engineer (Full-time)} \hfill Aug 2025 - Apr 2026\\
Built robust inference serving systems for realtime voice AI applications serving 10M+ monthly voice minutes. Architected changes around whisper to enable 2.5$\times$ increase in throughput with minimal hit on performance. Designed a scheduling strategy for ASR systems achieving 43\% reduction in median E2E latency at high loads (Published at CAO @ ICLR 2026).

% Built in house MLOps agent for automating deployments, observability and CI/CD pipelines.

Won 2nd prize in company wide voice ai hackathon building an end to end voice agent prototype with real time multi-turn conversation handling and tool calling capabilities.
...
{\bf Gaussian Splatting TUI} $|$ \href{https://github.com/darshanmakwana412/tsplat}{tsplat} \hfill Apr 2026\\
tsplat renders 3D Gaussian Splatting scenes directly in your terminal using Unicode half blocks or any other supported graphics protocol, works with xterm, kitty, ghostty. It's written in rust and is CPU only for now, doesn't require GPU or display servers and it even works over SSH.
\end{minipage}%
\hfill
\begin{minipage}[t]{0.15\textwidth}
\vspace{-5pt}
\includegraphics[width=\textwidth]{../assets/images/projects/tsplat.png}
\end{minipage}
...
Open source implementation of the \href{https://arxiv.org/abs/2501.03229}{Gaussian MAE} paper which leverages Gaussian splats as intermediate latent representation, enabling certain zero-shot capabilities like depth, splat grouping, etc.
\end{minipage}%
\hfill
\begin{minipage}[t]{0.15\textwidth}
\vspace{-5pt}
...
A minimal Implementation of gaussian splatting for 2D images in triton. Uses tile based differential rasterization similar to the original gaussian splatting paper but only works on 2D gaussian splats.
\end{minipage}%
\hfill
\begin{minipage}[t]{0.15\textwidth}
\vspace{-5pt}
...
An implementation of volumetric graph cut algorithms on visual hulls for 3D reconstruction from multiple views. Additionally ray casting for shading is used to render the final scene. This was our final course project for ME 735.
\end{minipage}%
\hfill
\begin{minipage}[t]{0.15\textwidth}
\vspace{-5pt}
...
This is a PoC of using fractal curves for tool path planning in layered 3D printing. It implements a path planning algorithm that recursively decomposes a region into disjoint smaller fractals resulting in a continuous printing path for any layer.
\end{minipage}%
\hfill
\begin{minipage}[t]{0.15\textwidth}
\vspace{-5pt}
...
\noindent\parbox[t]{\linewidth}{\raggedright\bf Real-World Baselines Challenge: Dynamic Train Rescheduling under Stochastic Perturbations}\\
Manuel Meyer, Christian Eichenberger, \textbf{Darshan Makwana} \textit{(+7 more)} \hfill
\begin{minipage}[t]{0.2\linewidth}\raggedleft
\href{https://flatland-association.github.io/flatland-book/_downloads/348b3e1efb2f66fc5a39bc6a33d6d56d/Real_World_Baselines_Challenge__Dynamic_Train_Rescheduling_under_Stochastic_Perturbations.pdf}{ECML PKDD 2026}\\
{\small\textit{under review}}
\end{minipage}

\vspace{0.1in}

\noindent\parbox[t]{\linewidth}{\raggedright\bf Duration Aware Scheduling for ASR Serving Under Workload Drift}\\
\textbf{Darshan Makwana}, Yash Jogi, Harsh Kotta, Aayush Kubba \hfill
\begin{minipage}[t]{0.2\linewidth}\raggedleft
\href{https://arxiv.org/abs/2603.11273}{CAO @ ICLR 2026}
\end{minipage}

\vspace{0.1in}

\noindent\parbox[t]{\linewidth}{\raggedright\bf COVID Self diagnosis classification using BERT and LightGBM models}\\
R Chavda, \textbf{Darshan Makwana} \textit{(+2 more)} \hfill
\begin{minipage}[t]{0.2\linewidth}\raggedleft
SMM4H 2023
\end{minipage}
