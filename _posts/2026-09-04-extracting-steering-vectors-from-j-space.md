...
|  |  |
| --- | --- |
| ![Fitted caps steering vector: share of generated tokens in ALL CAPS vs steering coefficient at layer 13](/assets/images/posts/jlens-steering_image1.png) | ![Refusal direction recovered from the abliterated model: share of prompts refused vs steering coefficient at layer 15](/assets/images/posts/jlens-steering_image2.png) |
...
![PCA of the uppercase and lowercase token activations recovered from the J lens, against the ground truth caps steering vector](/assets/images/posts/jlens-steering_image3.png)
...
![Cosine similarity of a_UPPER - a_lower with the caps direction, J lens rows vs an identity lens](/assets/images/posts/jlens-steering_image4.png)
...
![Share of generated tokens in ALL CAPS vs steering coefficient, fitted vector vs the vocab centered J lens vector](/assets/images/posts/jlens-steering_image5.png)
...
|  |  |  |
| --- | --- | --- |
| ![J lens top tokens at layer 17, position 8](/assets/images/posts/jlens-steering_image6.png) | ![J lens top tokens at layer 22, position 10](/assets/images/posts/jlens-steering_image7.png) | ![J lens top tokens at layer 14, position 14](/assets/images/posts/jlens-steering_image8.png) |
...
![Completions from the model run with the activation recovered from the J lens over refusal tokens](/assets/images/posts/jlens-steering_image9.png)
...
![Share of harmless prompts refused vs steering coefficient, abliteration direction vs the direction derived from the J lens](/assets/images/posts/jlens-steering_image10.png)
