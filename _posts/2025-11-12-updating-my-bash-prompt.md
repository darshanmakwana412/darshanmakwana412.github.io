...
![bash-prompt_image1.png](/assets/images/posts/bash-prompt_image1.png) ![bash-prompt_image2.png](/assets/images/posts/bash-prompt_image2.png)
...
![bash-prompt_image3.png](/assets/images/posts/bash-prompt_image3.png)
...
function parse_git_dirty {
  [$(git status --porcelain 2> /dev/null)]($(git status --porcelain 2> /dev/null)) && echo "*"
}
...
![bash-prompt_image4.png](/assets/images/posts/bash-prompt_image4.png)
...
function parse_git_stat() {
  ...
  ins=$(grep -oE '[0-9]+ insertions?\(\+\)' <<<"$o" | grep -oE '^[0-9]+'); [-z $ins](-z $ins) && ins=0
  dels=$(grep -oE '[0-9]+ deletions?\(-\)'  <<<"$o" | grep -oE '^[0-9]+'); [-z $dels](-z $dels) && dels=0
...
![bash-prompt_image5.png](/assets/images/posts/bash-prompt_image5.png)

![bash-prompt_image6.png](/assets/images/posts/bash-prompt_image6.png)
